...
/**
 * This class contains constants for all the translations not implemented in PocketMine-MP used by this plugin
 * This class is generated manually, modify it by hand.
 *
 * @internal
 */
final class KnownTranslationKeys{
	public const NETHERREACTOR_ACTIVE = "tile.netherreactor.active";
	public const NETHERREACTOR_BUILD_TOO_HIGH = "tile.netherreactor.builtTooHigh";
